...
public class InterpreterList extends MiniPage {
    JButton add;
    Vector<Vector<String >> data;
    ListSelectionModel sm;

    public InterpreterList(Portal portal) throws HeadlessException {
        super(portal);
        Vector<Author> authors = portal.getInterpreters();
